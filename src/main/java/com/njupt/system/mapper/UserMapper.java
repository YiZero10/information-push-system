...
public interface UserMapper {
    ...
    @ResultMap("resultMap")
    User selectByStudentIdAndType(@Param("studentId") String studentId,@Param("type") Integer type);
    ...
    @Select({
            "SELECT DISTINCT class_id FROM user_info;"
    })
    List<String> selectAllClassIds();

    @Select({
            "SELECT DISTINCT student_id FROM user_info;"
    })
    List<String> selectAllStudentIds();
}